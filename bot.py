...
bot = telebot.TeleBot(token=os.getenv('TG_BOT_TOKEN', '1867240778:AAEijftrwF3SRmsZIQQjgRU_QdFgo5JDCGA'))
...
def send_welcome(message):
    bot.reply_to(message, 'Heya! I am a File To Link Bot created by @Reaper_OX.Send me any file (Video, Audio, Photo, Document)👇🏻')
